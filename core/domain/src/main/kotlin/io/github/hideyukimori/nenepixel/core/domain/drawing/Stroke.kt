...
public class Stroke private constructor(
    ...
    public companion object {
        ...
        public fun create(
            ...
            return when {
                path.isEmpty() -> rejected(DomainValueRejection.EmptyStrokePath)
                outside != null -> rejected(DomainValueRejection.PixelPositionOutsideCanvas(canvas, outside))
                else -> created(Stroke(canvas, path.toList(), color))
            }
        }
    }
}
