...
Status: verified on 2026-09-01 for `P0-05` / Issue #9
...
| `ARC-003` | platform-free core graph in `ModuleArchitectureValidatorTest` | temporary `:core:domain` declared `androidx.compose.runtime:runtime` | `validateArchitecture` failed: `ARC-003 prohibits implementation dependency` |
