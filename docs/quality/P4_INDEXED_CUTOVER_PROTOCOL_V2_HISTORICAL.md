...
Protocol identity: `nene-pixel-p4-indexed-cutover-verification-v2`.

Revision v2 supersedes the [uncollected v1 contract](P4_INDEXED_CUTOVER_PROTOCOL_V1_HISTORICAL.md).
No v1 sample or verdict exists. Independent implementation review found that device collectors
