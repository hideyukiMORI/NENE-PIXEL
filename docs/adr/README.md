...
| [0005](0005-pixel-color-representation-and-limits.md) | proposed | Evidence gate and decision surface for pixel/color representation and bounded canvas, patch, and history policy |
