...
[ADR 0024](0024-indexed-project-compatibility.md) replace the live RGBA storage and tool-palette
...
indexed performance verdict. Post-v2 rollback must retain both readers under ADR 0024.
